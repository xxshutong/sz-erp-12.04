...
<form id="editpersonform2" method="post" action="<@ofbizUrl>createPerson/${donePage}</@ofbizUrl>" name="editpersonform">
    ...
    <div>
        ...
        <table width="90%" border="0" cellpadding="2" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="30" name="firstName"
                           value="${personData.firstName?if_exists}"/>
                    *
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="4" maxlength="4" name="middleName"
                           value="${personData.middleName?if_exists}"/>
                </td>
            </tr>
            <tr>
                <td align="right">${uiLabelMap.PartyLastName}</td>
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="30" name="lastName"
                           value="${personData.lastName?if_exists}"/>
                    *
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="10" maxlength="30" name="suffix"
                           value="${personData.suffix?if_exists}"/>
                </td>
            </tr>
            <tr>
                <td align="right">${uiLabelMap.PartyNickName}</td>
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="60" name="nickname"
                           value="${personData.nickname?if_exists}"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="11" maxlength="20" name="birthDate"
                           value="${(personData.birthDate.toString())?if_exists}"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="60" name="height"
                           value="${personData.height?if_exists}"/>
                </td>
            </tr>
            <tr>
                <td align="right">${uiLabelMap.PartyWeight}</td>
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="60" name="weight"
                           value="${personData.weight?if_exists}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="60" name="mothersMaidenName"
                           value="${personData.mothersMaidenName?if_exists}"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="60" name="socialSecurityNumber"
                           value="${personData.socialSecurityNumber?if_exists}"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="60" name="passportNumber"
                           value="${personData.passportNumber?if_exists}"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="11" maxlength="20" name="passportExpireDate"
                           value="${personData.passportExpireDate?if_exists}"/>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="60" name="totalYearsWorkExperience"
                           value="${personData.totalYearsWorkExperience?if_exists}"/>
                </td>
            </tr>
            <tr>
                <td align="right">${uiLabelMap.CommonComment}</td>
                <td>
                    <input type="text" class='inputBox' size="30" maxlength="60" name="comments"
                           value="${personData.comments?if_exists}"/>
                </td>
            </tr>
        </table>
    </div>
    ...
    &nbsp;<a href='<@ofbizUrl>${donePage}</@ofbizUrl>' class="button">${uiLabelMap.CommonGoBack}</a>
    &nbsp;<a id="editpersonform3" href="javascript:document.editpersonform.submit()"
